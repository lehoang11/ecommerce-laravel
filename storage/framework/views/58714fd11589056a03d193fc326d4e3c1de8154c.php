            ...
            <div class="container">
                <nav class="sidenav" data-sidenav data-sidenav-toggle="#sidenav-toggle">
                   ...
                   <a href="javascript:;" class="toggle" id="sidenav-toggle">
                    ...
                    <a href="<?php echo e(BASE_URL); ?>" class="mb-logo">NOREMON</a>
                    <a href="<?php echo e(action('CartController@index')); ?>" class="mb-cart">
                        <span class="mb-cart-icon">
                            <i class="material-icons">shopping_cart</i>
                            <?php $totalCart = Cart::content()->count(); ?>
                            <?php if($totalCart): ?> <sup><?php echo e($totalCart); ?></sup><?php endif; ?>
                        </span>
                    </a>
                </div>
            </div>
              ...
              <div class="mb-header-form">
                  <div class="container">
                    <form action="<?php echo e(action('SearchController@index')); ?>" method="GET" class="form-inline">
        ...
        <div class="header-wrap">	
            ...
            <span class="logo-text">NOREMON</span>   
    			...
    			<div class="form-search">
    				<form action="<?php echo e(action('SearchController@index')); ?>" class="navbar-form form-inline" method="GET">
    			...
    			<div class="col-lg-4 col-md-4 col-sm-4 header-link">
    				...
    				<div id="header-cart">
    					<a href="<?php echo e(action('CartController@index')); ?>" class="header-cart item">
    						<i class="fa fa-cart-plus bigfonts" aria-hidden="true"></i>
    						 Giỏ hàng
                <?php $totalCart = Cart::content()->count(); ?>
    						<?php if($totalCart): ?> <span class="cart-count"> <?php echo e($totalCart); ?></span><?php endif; ?>                
    					</a>
    				</div>
    			</div>
        </div>
...
<div class="main-navbar cate-wrap d-none d-sm-block min-w1270">
    <div class="navbar-wrap">
        <div class="cate-nav ">
            <ul>
                <li class="nav-item">
                  <a href="<?php echo e(BASE_URL); ?>" style="color: #189eff;">NOREMON<span style="color: #555;;">vn</span></a>
                </li>
                <li class="cate-sub nav-item">
                    ...
                    <div class="sub-menu animated fadeIn">
                        <ul> 
                          <?php if($global_cate): ?> 
                          <?php $__currentLoopData = $global_cate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>               
                            <li class="cat-item">
                                <a href="<?php echo e(action('ProductController@productCate',['slug'=>$item->slug,'cate_id'=>$item->id])); ?>">
                                ...
                                <div class="sub-menu-2">
                                    <div class="cat-sub-menu cat-box">
                                      <div class="left">
                                        <div class="title-box">
                                            <div class="title"><?php echo e($item->name); ?>
                                        ...
                                        <div class="row">
                                          <?php if($item['child']): ?>
                                          <?php $__currentLoopData = $item['child']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="col-md-6">
                                                <div class="item">
                                                    <div class="title"><?php echo e($value->name); ?></div>
                                                    <ul>
                                                      <?php if($value['min']): ?>
                                                        <?php $__currentLoopData = $value['min']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vmin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <li>
                                                            <a href="<?php echo e(action('ProductController@productCate',['slug'=>$vmin->slug,'cate_id'=>$vmin->id])); ?>"><?php echo e($vmin->name); ?></a>
                                                        </li>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                      <?php endif; ?>

                                                        <li>
                                                            <a href="<?php echo e(action('ProductController@productCate',['slug'=>$value->slug,'cate_id'=>$value->id])); ?>">Xem tất cả &gt;&gt;</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
