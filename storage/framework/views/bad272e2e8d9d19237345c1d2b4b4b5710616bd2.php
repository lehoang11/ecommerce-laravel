		...
		<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 col-xl-8 main-cart">
			...
			<div class="table-responsive">
	            <table class="table ">
	            	<thead>
			            <tr>
			            	<td class="text-center"><?php echo e($countCart); ?> Sản phẩm</td>
			        ...
			        <tbody>
	                    ...
	                    <tr class="cart-item cart-item-<?php echo e($item->rowId); ?>">
			                <td style="position: relative;">
			                	<img src="<?php echo e(asset($item->options['img'])); ?>" style="width: 120px;">
			                	
			                	<div><?php echo e($item->name); ?></div>
			                	
			                	<a href="javascript:void(0)" class="btn btn-default btn-del-cart" cartId ="<?php echo e($item->rowId); ?>"><i class="fa fa-trash-o bigfonts" aria-hidden="true"></i></a>
			                </td>
			                ...
			                <td class="quantity-item">
								<div class="input-group product-qty">
									<span class="input-group-btn">
										<button class="btn btn-default btn-update-cart" data-dir="min" data-id="<?php echo e($item->rowId); ?>">-</button>
									</span>
									<input type="text" class="form-control text-center" value="<?php echo e($item->qty); ?>" disabled="">
									<span class="input-group-btn">
										<button class="btn btn-default btn-update-cart" data-dir="plus" data-id="<?php echo e($item->rowId); ?>" >+</button>
									</span>
								</div>
			                </td>
			            </tr>
	    ...
	    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 col-xl-4 right">
	    	<div class="cart-check-ri">
	    		...
	    		<div class="cart-total-sub">
	    			<span>Tạm tính (<?php echo e($countCart); ?> sản phẩm)</span>
	    		...
	    		<div class="btn-checkout">
	    			<a href="<?php echo e(action('ShippingController@form_create')); ?>" class="btn" type="button"><span class="text">Mua hàng không cần đăng ký</span></a>
	    		</div>
	    	</div>
	    </div>
	</div>
